...
begin
  ...
  begin
    case ADialect of
      ddFirebird, ddPostgreSQL: SQLType := 'TIMESTAMP';
      ddSQLite: SQLType := 'DATETIME';
    end;
  end
  else
  ...
  if (dboAutoInc in DeltaField.DBOptions) and (dboPrimaryKey in DeltaField.DBOptions) then
  begin
    case ADialect of
      ddFirebird:
        AutoInc := 'GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL';
      ddPostgreSQL:
        AutoInc := 'SERIAL PRIMARY KEY NOT NULL';
      ddSQLite:
        AutoInc := 'PRIMARY KEY AUTOINCREMENT NOT NULL';
    else
      AutoInc := '';
    end;
